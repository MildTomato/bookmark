...
alter table "public"."bookmarks" add constraint "bookmarks_insert_by_fkey" FOREIGN KEY (insert_by) REFERENCES auth.users(id) ON DELETE CASCADE not valid;

alter table "public"."bookmarks" validate constraint "bookmarks_insert_by_fkey";
